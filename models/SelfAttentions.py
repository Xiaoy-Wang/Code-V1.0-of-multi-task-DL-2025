...
#         # 假设 encoderOut 的形状是 [batch_size, seq_len, hidden_dim]
#         query = self.query_projection(encoderOut)
#         key = self.key_projection(encoderOut)
#         value = self.value_projection(encoderOut)
#
#         # 计算点积注意力
...
#
#         # 加权求和值
#         output = torch.matmul(attention_weights, value)  # [batch_size, seq_len, hidden_dim]
#
#         return output
